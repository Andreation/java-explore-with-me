...
public class UserController {
    ...
    public UserDto postUser(@RequestBody @Valid InputUserDto inputUserDto) {
        log.debug("POST request to /admin/users with parameters: inputUserDto = " + inputUserDto);
        return userService.postUser(inputUserDto);
    }
